@ST_7778 @tagtagtag @this_is_story_tag
...
@SC_51816 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_51817 @third_scenario_tag
...
@SC_51818 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_51819 @fifth_scenario_tag
